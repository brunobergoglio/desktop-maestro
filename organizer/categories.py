...
DOCUMENTS = Category(
    ...
    icon="📄",
    extensions={
        ".txt", ".md", ".markdown", ".rtf", ".odt", ".doc", ".docx",
        ".tex", ".log", ".pages", ".wpd", ".wps",
        ".csv",
    },
    priority=5,
)
...
ARCHIVES = Category(
    ...
    extensions={
        ...
        ".zst", ".tgz", ".tbz2", ".tzst", ".lz", ".lzma",
        ".z", ".arj", ".cab", ".lha", ".ace",
        ".dmg", ".iso", ".img", ".vcd", ".toast",
        ".pkg", ".war", ".ear", ".jar",
    },
    priority=10,
)
...
VIDEOS = Category(
    ...
    extensions={
        ...
        ".3gp", ".3g2", ".ogv", ".rm", ".rmvb", ".swf",
        ".avchd", ".divx", ".xvid", ".h264", ".h265", ".hevc",
        ".srt", ".sub", ".idx", ".ass",  # subtitles
    },
    priority=10,
)
...
AUDIO = Category(
    ...
    extensions={
        ...
        ".opus", ".aiff", ".alac", ".ac3", ".dts", ".mid", ".midi",
        ".pcm", ".wv", ".tta", ".ape", ".dsf", ".dff",
        ".au", ".snd",
    },
    priority=10,
)
...
CODE = Category(
    ...
    extensions={
        ...
        ".toml", ".ini", ".cfg", ".conf",
        ".sh", ".bash", ".zsh", ".fish",
        ".c", ".cpp", ".h", ".hpp", ".java", ".kt", ".kts", ".swift",
        ".go", ".rs", ".rb", ".php", ".pl", ".pm", ".lua", ".r",
        ".sql", ".graphql", ".gql",
        ".dockerfile", ".makefile", ".cmake",
        ".env", ".gitignore", ".gitkeep", ".gitattributes",
        ".vue", ".svelte", ".astro", ".ejs", ".hbs", ".pug",
        ".ipynb", ".jl", ".scala", ".clj", ".cljs", ".ex", ".exs",
        ".erl", ".hs", ".ml", ".mli", ".fs", ".fsx",
...
DESIGN = Category(
    ...
    extensions={
        ...
        ".indd", ".idml", ".indb",
        ".cdr", ".dwg", ".dxf",
        ".blend", ".fbx", ".obj", ".3ds", ".max", ".ma", ".mb",
        ".glb", ".gltf", ".usdz", ".stl",
        ".ae", ".aep", ".prproj", ".fcpxml", ".drp",
        ".lottie", ".tga",
    },
    priority=8,
)
